...
import com.jimujia.pos.view.EditTextUtils;
 ...
 * 主界面金额输入公共Activity
 */
@ContentView(R.layout.input_amount_layout)
public class BaseInputAmountActivity extends BaseActivity implements View.OnClickListener {

    @ViewInject(R.id.input_amount_etSumMoney)
    public EditText etSumMoney;
    @ViewInject(R.id.input_amount_imagEliminate)
    ImageButton imagEliminate;
    @ViewInject(R.id.input_amount_tvOne)
    TextView tvOne;
    @ViewInject(R.id.input_amount_tvTwo)
    TextView tvTwo;
    @ViewInject(R.id.input_amount_tvThree)
    TextView tvThree;
    @ViewInject(R.id.input_amount_tvFour)
    TextView tvFour;
    @ViewInject(R.id.input_amount_tvFive)
    TextView tvFive;
    @ViewInject(R.id.input_amount_tvSix)
    TextView tvSix;
    @ViewInject(R.id.input_amount_tvSeven)
    TextView tvSeven;
    @ViewInject(R.id.input_amount_tvEight)
    TextView tvEight;
    @ViewInject(R.id.input_amount_tvNine)
    TextView tvNine;
    @ViewInject(R.id.input_amount_tvZero)
    TextView tvZero;
    @ViewInject(R.id.input_amount_tvSpot)
    TextView tvSpot;

//    public static final String AMOUNT_MARK = "￥";
    public static final String AMOUNT_MARK = "";
    /**
     * 金额拼接
     */
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.input_amount_tvOne:
                ...
                etSumMoney.setText(AMOUNT_MARK + pending);
                break;
            case R.id.input_amount_tvTwo:
                if (!pending.toString().contains(".")) {
                    if(pending.toString().length()>=5){
                        return;
                    }
                ...
                etSumMoney.setText(AMOUNT_MARK + pending);
                break;
            case R.id.input_amount_tvThree:
                if (!pending.toString().contains(".")) {
                    if(pending.toString().length()>=5){
                        return;
                    }
            ...
            case R.id.input_amount_tvSix:
                ...
                etSumMoney.setText(AMOUNT_MARK + pending);
                break;
            case R.id.input_amount_tvSeven:
                if (!pending.toString().contains(".")) {
                    if(pending.toString().length()>=5){
                        return;
                    }
                ...
                etSumMoney.setText(AMOUNT_MARK + pending);
                break;
            case R.id.input_amount_tvEight:
                if (!pending.toString().contains(".")) {
                    if(pending.toString().length()>=5){
                        return;
                    }
            ...
            case R.id.input_amount_tvSpot:
                ...
                break;
            case R.id.input_amount_imagEliminate:
                //删除
                if (pending.length() != 0) {
