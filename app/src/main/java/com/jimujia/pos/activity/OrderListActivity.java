...
public class OrderListActivity extends BaseActivity implements View.OnClickListener,XListView.IXListViewListener,
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new OrderListAdapter(activity,list);
            ...
            if(Constants.RETURN_SUCCESS.equals(baseResponseData.getReturnCode())){
                ...
                if(returnDataObject!=null){
                    ...
                    if(Utils.isNotEmpty(returnDataStr)){
                        OrderListResData orderListResData = gson.fromJson(returnDataStr, OrderListResData.class);
                        //分页信息
                        PaginatedData paginated = orderListResData.getPaginated();
                        ...
                        orderList = orderListResData.getOrder_list();
